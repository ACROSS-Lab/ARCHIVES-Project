...
*
* PERFORMANCE NOTES (optimized variant, 2026-06-13). Behaviour and numerics are IDENTICAL to
*   "Hanoi ABM Flood Model 1926.gaml"; only these speed-only changes were applied (no formula or
*   constant touched):
